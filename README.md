...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/Vaibhavme22/Recommendation-system/blob/main/requirements.txt) file with the command `pip install -r requirements.txt`.
